...
// Taken from https://github.com/madler/zlib/blob/master/crc32.h
/* crc32.h -- tables for rapid CRC calculation
 * Generated automatically by crc32.c
 */

const uint32_t crc_table[TBLS][256] =
{
  {
...
// taken (then modifed) from https://github.com/madler/zlib/blob/master/crc32.c
...
uint32_t calc_crc32(uint32_t crc, const uint8_t *buf, size_t len) noexcept
{
    ...
    if (sizeof(void *) == sizeof(ptrdiff_t)) {
        ...
        // TODO(peter): use https://cmake.org/cmake/help/v3.5/module/TestBigEndian.html
        // to set a compile definition for if big endian
...
/* ========================================================================= */
uint32_t crc32_little(uint32_t crc, const uint8_t *buf, size_t len)
{
    uint32_t c;
    const uint32_t *buf4;
